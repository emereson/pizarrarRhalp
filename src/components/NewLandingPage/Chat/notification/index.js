...
export default function Notification() {
  return (
    <div className="landing-page-notification" style={{ padding: '10px 5px' }}>
      <p>
      ...
      <form className="landing-page-notification-form">
        <input
          className="landing-page-notification-inputs"
          placeholder="Your Number..."
        />
        <input className="landing-page-notification-inputs" placeholder="Your Name..." />
      </form>
    </div>
  );
}
